// TODO - add search functionality to find a character - https://swapi.dev/api/people/?search={someName}
...
export default function CharactersList({ url }) {
  ...
  return (
    <>
      <div className="characters u-margin-top-medium u-margin-bottom-medium">
        {!data.results.length ? (
          <div className="characters__empty">No characters found</div>
        ) : (
          <>
